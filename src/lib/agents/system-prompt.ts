...
const pageContexts: Record<BeaconPage, string> = {
  dashboard: `The user is on the Acquisition & Onboarding Dashboard. Key metrics: $1.8B total category revenue (↑24% YoY), $2.5B revenue goal, 23% of assortment gap covered, 2,345 active sellers. There are 47 high-priority gaps totaling $52.8M opportunity. A holiday plan window is active (Nov 26 – Dec 25, 2026). The pipeline heatmap shows sellers across Discovered → Shortlisted → Contacted → Onboarding → Established stages.
