...
import {
  buildLiveAnalysisSourceForVersion,
...
export function AssortmentAnalysisTab({
  content: fallbackContent,
  tmApprove,
}: AssortmentAnalysisTabProps) {
  ...
  const activeSource = useMemo(() => {
    ...
    return buildLiveAnalysisSourceForVersion(content, activeVersion.id);
